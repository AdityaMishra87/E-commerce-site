  ...
  return (
    ...
    <div className="container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24 ">
          {cart.products.length > 0 ? (
            ...
            <div className="flex justify-center flex-col md:items-center mt-6 p-8">
              <img src={EmptyCart} alt="" className="h-98" />
              <h3 className="text-red-500">Your cart is empty</h3>
